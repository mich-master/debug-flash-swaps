...
// const WETH9_ABI_PATH: &'static str = "/media/mich/speedwork/NeonLabs/uniswap-v2-periphery/build/WETH9.json";
// const ERC20_ABI_PATH: &'static str = "/media/mich/speedwork/NeonLabs/uniswap-v2-periphery1/build/IERC20.json";
// const ERC20WRAPPER_ABI_PATH: &'static str = "/media/mich/speedwork/Solidity/erc20wrapper/build/contracts/IERC20.json";
// const UNISWAP_V2_FACTORY_ABI_PATH: &'static str = "/media/mich/speedwork/NeonLabs/uniswap-v2-periphery1/node_modules/@uniswap/v2-core/build/UniswapV2Factory.json";
// const UNISWAP_V2_ROUTER02_ABI_PATH: &'static str = "/media/mich/speedwork/NeonLabs/uniswap-v2-periphery1/build/UniswapV2Router02.json";


const ETH_ACCOUNT_KEY: &'static str = "283e506a4a706ef8c3204f00958b7a4cd902e94a1fdf50a71bcba439dac0f3fb";
const ETH_ACCOUNT: &'static str = "1beb0aEb41AcA04467BF4FA9913a41188FF9C082";
// const UNISWAP_V2_FACTORY_ADDRESS: &'static str = "1814A26B21CEdf2A87dDd1d9a8524173920e30Db";
// const UNISWAP_V2_ROUTER02_ADDRESS: &'static str = "2405cE5ce29c0E834764c3Dd2078e71c4dBc77b5";
...
impl NeonswapEnvironment {
    ...
    pub fn new(web3: web3::Web3<web3::transports::Http>,
        ...
        NeonswapEnvironment {
            web3,
            contract_paths,
            signing_key: SecretKey::from_str(ETH_ACCOUNT_KEY).unwrap(),
            signing_address: EthAddress::from_str(ETH_ACCOUNT).unwrap().into(),
